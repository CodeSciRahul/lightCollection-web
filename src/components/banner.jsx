      ...
      <div className="relative h-[500px] md:h-[650px]">
        {banners.map((banner, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-pink-900/70 via-pink-700/40 to-transparent" />

            <div className="absolute inset-0 flex items-center">
              <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
                <div className="max-w-xl text-white">
                  <span className="inline-block px-4 py-2 rounded-full bg-pink-500/30 backdrop-blur-md text-sm font-medium border border-pink-300">
                  ...
                  <h2 className="text-pink-200 text-3xl md:text-5xl font-bold mt-3">
                    {banner.subtitle}
                  </h2>

                  <p className="mt-6 text-lg text-pink-50">
                    {banner.description}
                  </p>

                  <div className="flex gap-4 mt-8">
                    <button className="bg-pink-500 hover:bg-pink-600 px-8 py-4 rounded-full font-semibold transition">
                      Shop Now
                    </button>
          ...
          {banners.map((_, index) => (
            <button
              ...
              className={`transition-all duration-300 ${
                current === index
                  ? "w-10 h-3 bg-pink-500 rounded-full"
