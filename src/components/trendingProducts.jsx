      ...
      <section className="py-20 bg-gradient-to-b from-white via-pink-50/40 to-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-14">
            <span className="text-pink-500 font-semibold tracking-[4px] uppercase">
              Fashion Picks
            </span>
            ...
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              Discover the most loved styles curated specially
              for modern women.
            </p>
          </div>
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="bg-pink-500 text-white text-xs px-3 py-2 rounded-full font-semibold">
                      🔥 Trending
                    </span>
                  </div>
