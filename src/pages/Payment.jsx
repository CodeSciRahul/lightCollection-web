                    ...
                    <div className="bg-white rounded-xl border">
                        ...
                        <div className="p-5 space-y-4">
                            {addresses?.map((address) => (
                                <label
                                    key={address._id}
                                    className={`block border rounded-xl p-4 cursor-pointer transition ${selectedAddress === address._id
                                ...
                                {paymentMethods.map((method) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 p-4 border-b text-left transition ${selectedPayment === method.id
                                ...
                                {selectedPayment === "card" && (
                                    <div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <button className="w-full bg-pink-600 text-white py-3 rounded-lg font-medium">
